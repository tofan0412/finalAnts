...
public class MemlistExcelDownloadView extends AbstractView{
...
//	    mergeRowStyle2.setVerticalAlignment(VerticalAlignment.CENTER);
		...
		for(int i=0; i<6; i++) {
		    ...
		    row.createCell(i).setCellValue("회원 목록");
		...
		for(Map<String, String> map : data) {
			...
			cell = row.createCell(colnum++);
			cell.setCellStyle(bodyStyle);
			cell.setCellValue(map.get("memName"));	
			
			cell = row.createCell(colnum++);
			cell.setCellStyle(bodyStyle);
			cell.setCellValue(map.get("memTel"));
			
			cell = row.createCell(colnum++);
			cell.setCellStyle(bodyStyle);
			cell.setCellValue(map.get("memType"));	
			
			cell = row.createCell(colnum++);
			cell.setCellStyle(bodyStyle);
			cell.setCellValue(map.get("del"));
